...
import { Bars3BottomLeftIcon, FolderIcon, PencilSquareIcon, TrashIcon } from "@heroicons/react/24/outline";
import { listProjects } from "../api.js";
import { fetchClients, mergeClientRecords } from "../lib/clientStore.js";
import { listTasks, addTask, updateTask, reorderTasks, deleteTask } from "../api/tasks.js";
        ...
        <div className="flex items-start justify-between flex-wrap gap-4">
          <div>
            ...
            <div className="mt-4 flex gap-3 text-sm text-slate-600 flex-wrap">
              ...
              <span className="chip chip-soft">Open: {openCount}</span>
              {nextDue && (
          ...
          <div className="text-right space-y-2 text-sm text-slate-500">
            ...
            <div className="text-xs">Stored via /api/tasks.</div>
          </div>
        </div>
          ...
          <div className="table-scroll">
            <table className="table compact timeline-table" onDragOver={handleDragOver} onDrop={handleDrop}>
              ...
              <tbody>
                {loading && (
                  <tr>
                    <td className="td text-sm text-slate-500" colSpan={7}>Loading tasks…</td>
                  </tr>
                )}
                {!loading && filteredTasks.map((task, idx) => {
